...
// 		 * __construct
// 		 *
// 		 * A dummy constructor to ensure ARB is only setup once.
// 		 *
// 		 * @date    7/25/22
// 		 *
// 		 * @param   void
...
// 			// Define constants.
// 			$this->define( 'ARB', true );
// 			$this->define( 'ARB_PATH', plugin_dir_path( __FILE__ ) );
// 			$this->define( 'ARB_BASENAME', plugin_basename( __FILE__ ) );
// 			$this->define( 'ARB_VERSION', $this->version );
// 			$this->define( 'ARB_MAJOR_VERSION', 5 );

// 			// Define settings.
// 			// $this->settings = array(
// 			// 	'name'                   => __( 'Arboretum Custom', 'arb' ),
// 			// 	'slug'                   => dirname( ARB_BASENAME ),
// 			// 	'version'                => ARB_VERSION,
// 			// 	'basename'               => ARB_BASENAME,
// 			// 	'path'                   => ARB_PATH,
// 			// 	'file'                   => __FILE__,
...
// 			include_once ARB_PATH . 'includes/acf-utility-functions.php';
...
// 	* arb
// 	*
// 	* The main function responsible for returning the one true ARB Instance to functions everywhere.
